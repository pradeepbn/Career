...
\noindent {\href{mailto:pradipbn@gmail.com}{pradipbn@gmail.com}}\bull{\href{http://algoristparadise.blogspot.com/}http://algoristparadise.blogspot.com/}\bull{\textsmaller{+}1 (716) 445-7281}\bull{San Jose, CA}%\bull smith01 \textit{(Skype)}\bull % Your phone number(s) and Skype username
...
\roottitle{Personal Projects- \href{http://bit.ly/1GbcgAp}{http://bit.ly/1GbcgAp} (Github)} % Top level section
%\headedsection {}{}{}
%\begin{itemize}
\headedsubsection{\textsc{Machine Learning:}}{}{}
    \bodytext {
      \begin{itemize}
...
%      \end{itemize}
%    }
\headedsubsection{\textsc{Natural Language Processing:}}{}{}
    \bodytext {
      \begin{itemize}
		\item Built ``WordNet'' graphDB and outcast algorithm to categorize the keywords into context aware groups
	  \end{itemize}
    }
...
\roottitle{Associations and Activities} % Top level section
{
	...
	\headedsection % Employer name which can include a hyperlink and location/URL on the right side of the page
	{\hspace{0.15cm}Founder and President}
{\textsc{IEEE- ROBOMSR: Robotics Club}} {Feb '05 -- Jun '07}
	\bodytext {
	  \begin{itemize}
