...
\inlineheadsection{Strengths:}{6+ years of experience in commercial software design, development and production delivery}
\vspace{-0.65em}
\inlineheadsection{Keywords:}{C/C++/Python/Java, algorithms, data-structures, linux device driver, multi-threading, scripting}
...
\headedsubsection{\textsc{Graphics Processing:}}{}{}
    \bodytext {
      \begin{itemize}
        \item Nearest neighbor and radius search. E.g., facial pattern completion
        \item Pattern recognition
        \item Image resizing utility
      \end{itemize}
    }
