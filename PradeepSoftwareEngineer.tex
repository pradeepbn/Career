...
\begin{itemize}
  \item \textsc{Fun Stuff:} 8-Puzzle game solver, wordnet
  \item \textsc{Tools:} Image resizing utility
  \item \textsc{Simulator:} Percolation, pattern recognition, nearest neighor/ range search
\end{itemize}
%  \begin{itemize}
