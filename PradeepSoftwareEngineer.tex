...
\headedsection {\href{http://bit.ly/1IKq0Tx}{Github}}{
  \begin{itemize}
	\item \textsc{8 Puzzle Game:} Implemented the 8-puzzle game using A* algorithm
	\item \textsc{Nearest neighbor/ Range search:} Developed the animated pixel selection using KD trees
	\item \textsc{Pattern Recognition:} Developed the code for pattern analysis on a large data set collection
	\item \textsc{Percolation:} Built a Monte-Carlo simulator for finding the percolation threshold in a N x N grid 
...
{\textsc{Coursera}} {\textsc{Online}} {
  ...
  {} {
	\\
  	\bull \textsc{dfs \bull bfs \bull minimum spanning tree \bull shortest paths
